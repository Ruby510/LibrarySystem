                ...
                <div id="l">
                    ...
                    <form method="post" action="connectlogin.php">
                        ...
                        <div class="link">
                            ...
                            <a href="register.php" id="signInButton" style="display: inline-block; padding: 8px 15px; background-color: #df9618; color: white; text-decoration: none; border: none; cursor: pointer;">Sign Up</a>
                        </div>
                    </form>   
                </div>
                </div>
